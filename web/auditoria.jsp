...
<body>
	...
	<div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header" style="color:#1e5a8e;">Consulta de Proyecto</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                <!-- /.panel-heading -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                                ...
                                                <label style="color:#ffffff">consultar</label>
                                                    </br>
                                        ...
                                        <div class="form-group">
                                            <br/>
                                                <label>Proyecto</label>
                                                    <br/>
                                                        <input type="text" id="proyArch" disabled></input>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label>Vo.Bo.</label>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox"/>Validaci&oacute;n
                                                        </label>
                                                    </div>
                                            </div>
                                        </div>
