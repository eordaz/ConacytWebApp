...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header" style="color:#1e5a8e;">Registro Cuenta Bancaria </h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			...
			<div class="panel-body">
					...
					<li class="active"><a href="#home" data-toggle="tab">Solicitud de Apertura</a>
				
					</li>
					<li><a href="#profile" data-toggle="tab">Datos de la Cuenta Aperturada</a>
					...
					<br/>                           
							 ...
							 <div class="row">
								 <div class="col-lg-3"> <i class="fa fa-file-pdf-o fa-lg " aria-hidden="true" ></i> Caratula de Serv. y productos</div>
							
							 </div>
							 	 <br/>
							 <div class="row">
								 <div class="col-lg-2"> <i class="fa fa-file-pdf-o fa-lg " aria-hidden="true"> </i> Firmas</div>
 								
							 </div>	 
							  <br/>
							 <div class="row">
  							     <div class="col-lg-2"> <i class="fa fa-file-pdf-o fa-lg " aria-hidden="true"></i> Responsiva</div>
							 </div>
					</div>
					...
					<br/>
							<div class="panel panel-primary">
										...
										<div class="panel-heading">
            		              	 	 <i class="fa fa-fw"></i> Datos de Cuenta  Bancaria
                    			    	</div>
											<div class="panel-body">
												<div class="row">  
								  ...
								  <div class="col-lg-6">
                                 	<div class="form-group">
                                            <label>Nombre de la Cuenta Bancaria</label>
                                            <input class="form-control">
                                    </div>
								 </div>
                             </div>
